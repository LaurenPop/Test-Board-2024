...
frc::SmartDashboard::PutNumber("Timer", CHRIS_Second);

  // RobotMotorCommands();
  vROBO_t_MotorTime += C_ExeTime;
  //if (vROBO_t_MotorTime -= vROBO_b_MotorPower);
if (CHRIS_Second <60 )
{
  SparkSpeedPID = 0.5;
}else if (CHRIS_Second > 60 && CHRIS_Second < 120 ){
  SparkSpeedPID = 0.2;
}else if (CHRIS_Second > 120 && CHRIS_Second < 180 ){
  SparkSpeedPID = 0.5;
}else if (CHRIS_Second > 180 && CHRIS_Second < 240 ){
  SparkSpeedPID = 0.7;
}else if (CHRIS_Second > 240 && CHRIS_Second < 300 ){
  SparkSpeedPID = 0.4;
}else if (CHRIS_Second > 300 && CHRIS_Second < 360 ){
  SparkSpeedPID = 0.2;
}else if (CHRIS_Second > 360 && CHRIS_Second < 420 ){
  SparkSpeedPID = 0.5;
}else if (CHRIS_Second > 420 && CHRIS_Second < 480 ){
  SparkSpeedPID = 0.7;
}else if (CHRIS_Second > 480 && CHRIS_Second < 540 ){
  SparkSpeedPID = 0.4;
}else if (CHRIS_Second > 540 && CHRIS_Second < 600 ){
  SparkSpeedPID = 0.2;
}else if (CHRIS_Second > 600 && CHRIS_Second < 660 ){
  SparkSpeedPID = 0.0;
}
  spark1.Set(SparkSpeedPID);
  spark2.Set(SparkSpeedPID);
  spark3.Set(SparkSpeedPID);
  spark4.Set(SparkSpeedPID);
}
